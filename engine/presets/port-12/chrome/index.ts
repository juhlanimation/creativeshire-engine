      ...
      widgets: [
        {
          ...
          type: 'Link',
          props: { href: 'mailto:{{ content.footer.email }}' },
          className: 'port12-footer__contact-item',
          widgets: [
            { type: 'Text', props: { content: 'Mail: {{ content.footer.email }}', as: 'span' } },
          ],
        },
        {
          id: 'footer-phone',
          ...
          className: 'port12-footer__contact-item',
          widgets: [
            { type: 'Text', props: { content: 'Tlf. {{ content.footer.phoneDisplay }}', as: 'span' } },
          ],
        },
        {
          id: 'footer-address',
