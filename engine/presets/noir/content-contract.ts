 ...
 *
 * Declares ALL CMS fields the noir preset reads.
...
export const noirContentContract: ContentContract = {
  sections: [
{ id: 'head', label: 'Head', description: 'Page title and meta description' },
  ...
  sourceFields: [
    ...
    // ── Projects ───────────────────────────────────────────────────────
    {
      ...
      required: true,
      itemFields: [
        { path: 'id', type: 'text', label: 'Project ID', section: 'projects', required: true, hidden: true },
