/**
 * Bishoy Gendi Preset Content Contract
 *
 * Declares every CMS source field the bishoy-gendi preset reads.
...
export const bishoyGendiContentContract: ContentContract = {
  sections: [
  ...
  sourceFields: [
    // ── Intro ──────────────────────────────────────────────────────────────
    { path: 'intro.maskText', type: 'text', label: 'Intro Mask Text', section: 'intro', required: true, default: 'BISHOY' },
    ...
    { path: 'projectsILike.defaultTab', type: 'text', label: 'Default Tab ID', section: 'projectsILike', default: 'ldr' },
    {
      ...
      required: true,
      itemFields: [
        { path: 'id', type: 'text', label: 'Tab ID', section: 'projectsILike', required: true },
