---
name: zustand
description: Zustand state management patterns. Use when working with store code, implementing actions, managing state, or creating slices. Triggers on Zustand store development, state management questions, or action implementation.
user-invocable: false
---

# Zustand State Management

Patterns for Zustand stores in React applications.
...
- [Action patterns](references/action-patterns.md) - Optimistic updates, loading states, SWR integration
- [Slice organization](references/slice-organization.md) - Store structure, slice patterns, best practices
