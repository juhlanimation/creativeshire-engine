...
```
creativeshire/content/widgets/layout/{WidgetName}/
...
```
creativeshire/content/widgets/composite/{CompositeName}/
...
```ts
import type { WidgetSchema } from "@/creativeshire/schema/widget";
...
```ts
import type { SectionSchema } from "@/creativeshire/schema/section";
...
```ts
import type { BackgroundFeature } from "@/creativeshire/schema/features";
...
```
creativeshire/experience/behaviours/section/{behaviour-name}/
...
import { useExperience } from "@/creativeshire/experience";
...
```
creativeshire/presets/{preset-name}/
├── index.ts                        # Barrel export
...
import { InfiniteCarouselExperience } from "@/creativeshire/experience/experiences/infinite-carousel";
import { StackBehaviour } from "@/creativeshire/experience/behaviours/section/stack";
import { NavTimelineChrome } from "@/creativeshire/content/chrome/regions";
