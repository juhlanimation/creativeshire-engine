...
```
creativeshire/components/content/sections/patterns/
├── Hero/
...
```
creativeshire/components/content/sections/patterns/{Name}/
├── index.ts
...
import { createAboutSection } from '@/creativeshire/content/sections/patterns/About'
