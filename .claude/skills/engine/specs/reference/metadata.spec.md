...
```typescript
// site/pages/about.ts
import type { PageSchema, PageHeadSchema } from '@/engine/schema'
...
import type { PageHeadSchema } from '@/engine/schema'
...
```typescript
// engine/content/chrome/JsonLd.tsx
import type { JsonLdSchema } from '@/engine/schema'
