...
```tsx
// engine/content/widgets/primitives/HeroImage/index.tsx
import './styles.css';
...
```css
/* engine/content/widgets/primitives/HeroImage/styles.css */
[data-widget="hero-image"] {
...
```typescript
// engine/content/widgets/primitives/Button/index.tsx
