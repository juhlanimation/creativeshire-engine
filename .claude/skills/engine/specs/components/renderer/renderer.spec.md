...
```typescript
// SectionRenderer.tsx
import { resolveBehaviour } from '@/engine/experience/behaviours/resolve'
import { useExperience } from '@/engine/experience/ExperienceProvider'
import { useFeatures } from '@/engine/experience/features'
import { BehaviourWrapper } from '@/engine/experience/BehaviourWrapper'
