...
The Site Instance contains configuration and content for this specific website. Sites extend presets from `engine/presets/` using spread syntax, overriding specific values while inheriting defaults. The engine lives in `engine/`. Instance data lives in `site/`.
...
6. Use section patterns from `engine/content/sections/patterns`

### Must Not

1. Modify creativeshire code - extend via schema only
2. Import from `engine/experience/` directly
...
```typescript
// site/pages/home.ts
import { createGallerySection } from '@/engine/content/sections/patterns/Gallery'
...
```typescript
// site/config.ts
import { SiteSchema } from '@/engine/schema'
import { showcasePreset } from '@/engine/presets/showcase'
...
```typescript
// site/pages/home.ts
import { PageSchema } from '@/engine/schema'
...
// engine/content/widgets/Text/index.tsx
...
|----------------|-----------|-----|
| `engine/presets` | Imports | Extends preset configurations |
| `engine/schema` | Imports | Uses type definitions |
| `engine/content/sections/patterns` | Imports | Section factory functions |
...
```typescript
// engine/experience/modes/reveal/index.ts
...
```typescript
// engine/experience/behaviours/fade-in/index.ts
...
```typescript
// engine/content/widgets/composites/ProjectCard/types.ts
...
// engine/content/widgets/composites/ProjectCard/index.ts
...
```typescript
// engine/content/sections/patterns/Gallery/index.ts
import { SectionSchema } from '@/engine/schema'
import { createProjectCard } from '@/engine/content/widgets/composites/ProjectCard'
