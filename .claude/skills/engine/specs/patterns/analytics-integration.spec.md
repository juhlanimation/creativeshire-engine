...
const AnalyticsProvider = dynamic(
  () => import('@/engine/analytics/provider').then(m => m.AnalyticsProvider),
  { ssr: false }
)
...
import { useAnalytics } from '@/engine/analytics/hooks/useAnalytics'
...
import { useAnalytics } from './useAnalytics'
import { useExperienceStore } from '@/engine/experience/ExperienceProvider'
...
const AnalyticsProvider = dynamic(
  () => import('@/engine/analytics/provider'),
  { ssr: false }  // Prevents server-side rendering
)

// WRONG - Blocks initial bundle
import { AnalyticsProvider } from '@/engine/analytics/provider'
```
