...
```typescript
// engine/ErrorBoundary/index.tsx
'use client'
...
```typescript
// engine/renderer/WidgetRenderer.tsx
...
```typescript
// engine/Fallbacks/WidgetFallback.tsx
...
```typescript
// engine/renderer/SectionRenderer.tsx
import { ErrorBoundary } from '../components/ErrorBoundary'
...
```typescript
// engine/Fallbacks/SectionFallback.tsx
...
```typescript
// engine/experience/providers/DriverProvider.tsx
'use client'
...
```typescript
// engine/renderer/PageRenderer.tsx
...
```typescript
// engine/ErrorBoundary/ResetErrorBoundary.tsx
'use client'
...
```typescript
// engine/ErrorBoundary/index.tsx - Enhanced version
interface ErrorBoundaryProps {
  children: ReactNode
  fallback: ReactNode
...
```typescript
// engine/ErrorBoundary/index.test.tsx
...
```typescript
// engine/experience/drivers/ScrollDriver.test.ts
import { describe, it, expect, vi } from 'vitest'
