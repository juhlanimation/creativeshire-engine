...
```typescript
// engine/content/widgets/composite/ProjectCard/index.ts
...
```typescript
// engine/content/sections/patterns/Hero/index.ts
...
```typescript
// engine/content/widgets/primitives/Video/index.tsx
...
import { useScrollProgress } from '@/engine/experience/triggers' // WRONG
