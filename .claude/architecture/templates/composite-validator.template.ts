#!/usr/bin/env npx tsx
/**
 * {Agent} Composite Validator
 *
 * Chains domain validators and/or enforces path rules for this agent.
 * Lives next to agent contract: ./{agent}.agent.md
 *
...
const domainValidators: string[] = [
  // Example for widget-builder:
  // '../creativeshire/components/content/widgets/widgets.validator.ts',

  // Example for multi-domain agent:
  // '../creativeshire/components/content/widgets/widgets.validator.ts',
  // '../creativeshire/components/content/chrome/chrome.validator.ts',
]
...
const pathRules: {
  ...
  patterns: [
    // Example for executor (widget-builder):
    // /creativeshire\/content\/widgets\//,

    // Example for coordinator (technical-director):
    // /\.claude\/tasks\//,
    // /\.claude\/architecture\/.*\.md$/,
  ],

  message: 'This agent cannot write to this path. Check your contract.',
}
