#!/usr/bin/env npx tsx
/**
 * Renderer Builder Composite Validator
 *
 * Chains domain validators and/or enforces path rules for this agent.
 * Lives next to agent contract: ./renderer-builder.agent.md
 *
...
const AGENT_NAME = 'renderer-builder'
...
const domainValidators: string[] = [
  '../../creativeshire/components/renderer/renderer.validator.ts',
]
...
const pathRules: {
  ...
  message: 'renderer-builder can only write to creativeshire/renderer/. Check your contract.',
}
