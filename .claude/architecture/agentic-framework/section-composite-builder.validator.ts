#!/usr/bin/env npx tsx
/**
 * Section Composite Builder Composite Validator
 *
 * Chains domain validators and/or enforces path rules for this agent.
 * Lives next to agent contract: ./section-composite-builder.agent.md
 *
...
const AGENT_NAME = 'section-composite-builder'
...
const domainValidators: string[] = [
  '../../creativeshire/components/content/section-composite.validator.ts',
]

/**
 * Path rules for this agent.
 * Allowlist: only these paths are allowed
 */
const pathRules: {
  ...
  message: 'This agent can only write to creativeshire/components/content/sections/composites/',
}
