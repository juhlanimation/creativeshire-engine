#!/usr/bin/env npx tsx
/**
 * Runtime Validator Composite Validator
 *
 * Coordinator agent for runtime error detection.
 * Restricts writes to logging and task documentation only.
 *
 * Exit codes:
...
const AGENT_NAME = 'runtime-validator'
...
const pathRules: {
  ...
  message: 'Runtime Validator can only write to .claude/logs/ and .claude/tasks/ for reporting findings.',
}
