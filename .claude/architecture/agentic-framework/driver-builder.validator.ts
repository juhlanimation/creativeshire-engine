#!/usr/bin/env npx tsx
/**
 * Driver Builder Composite Validator
 *
 * Chains domain validators and/or enforces path rules for this agent.
 * Lives next to agent contract: ./driver-builder.agent.md
 *
...
const AGENT_NAME = 'driver-builder'
...
const domainValidators: string[] = [
  '../../creativeshire/components/experience/driver.validator.ts',
]
...
const pathRules: {
  ...
  message: 'driver-builder can only write to creativeshire/components/experience/driver/. Check your contract.',
}
