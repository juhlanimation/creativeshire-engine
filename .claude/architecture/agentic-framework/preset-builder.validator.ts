#!/usr/bin/env npx tsx
/**
 * Preset Builder Composite Validator
 *
 * Chains domain validators and/or enforces path rules for this agent.
 * Lives next to agent contract: ./preset-builder.agent.md
 *
...
const AGENT_NAME = 'preset-builder'
...
const domainValidators: string[] = [
  '../../creativeshire/components/preset/preset.validator.ts',
]
...
const pathRules: {
  ...
  message: 'preset-builder can only write to creativeshire/presets/, creativeshire/experience/modes/, or creativeshire/experience/experiences/. Check your contract.',
}
