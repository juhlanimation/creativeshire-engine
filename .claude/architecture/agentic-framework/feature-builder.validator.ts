#!/usr/bin/env npx tsx
/**
 * Feature Builder Composite Validator
 *
 * Chains domain validators and/or enforces path rules for this agent.
 * Lives next to agent contract: ./feature-builder.agent.md
 *
...
const AGENT_NAME = 'feature-builder'
...
const domainValidators: string[] = [
  '../../creativeshire/components/content/feature.validator.ts',
]
...
const pathRules: {
  ...
  message: 'feature-builder can only write to creativeshire/components/content/feature/',
}
