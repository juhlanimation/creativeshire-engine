#!/usr/bin/env npx tsx
/**
 * Section Builder Composite Validator
 *
 * Chains domain validators and/or enforces path rules for this agent.
 * Lives next to agent contract: ./section-builder.agent.md
 *
...
const AGENT_NAME = 'section-builder'
...
const domainValidators: string[] = [
  '../../creativeshire/components/content/section.validator.ts',
]
...
const pathRules: {
  ...
  patterns: [
    /creativeshire\/components\/content\/section\/(?!composites)/,
  ],

  message: 'Section builder can only edit creativeshire/components/content/section/ (excluding composites/)',
}
