#!/usr/bin/env npx tsx
/**
 * Trigger Builder Composite Validator
 *
 * Chains domain validators and/or enforces path rules for this agent.
 * Lives next to agent contract: ./trigger-builder.agent.md
 *
...
const AGENT_NAME = 'trigger-builder'
...
const domainValidators: string[] = [
  '../../creativeshire/components/experience/trigger.validator.ts',
]
...
const pathRules: {
  ...
  message: 'trigger-builder can only write to creativeshire/components/experience/trigger/',
}
