#!/usr/bin/env npx tsx
/**
 * Schema Builder Composite Validator
 *
 * Chains domain validators and/or enforces path rules for this agent.
 * Lives next to agent contract: ./schema-builder.agent.md
 *
...
const AGENT_NAME = 'schema-builder'
...
const domainValidators: string[] = [
  '../../creativeshire/components/schema/schema.validator.ts',
]
...
const pathRules: {
  ...
  message: 'schema-builder can only write to creativeshire/schema/. Check your contract.',
}
