#!/usr/bin/env npx tsx
/**
 * Widget Builder Composite Validator
 *
 * Chains domain validators and/or enforces path rules for this agent.
 * Lives next to agent contract: ./widget-builder.agent.md
 *
...
const AGENT_NAME = 'widget-builder'
...
const domainValidators: string[] = [
  '../../creativeshire/components/content/widget.validator.ts',
]
...
const pathRules: {
  ...
  message: 'widget-builder can only write to creativeshire/components/content/widget/. Check your contract.',
}
