#!/usr/bin/env npx tsx
/**
 * Behaviour Builder Composite Validator
 *
 * Chains domain validators and/or enforces path rules for this agent.
 * Lives next to agent contract: ./behaviour-builder.agent.md
 *
...
const AGENT_NAME = 'behaviour-builder'
...
const domainValidators: string[] = [
  '../../creativeshire/components/experience/behaviour.validator.ts',
]
...
const pathRules: {
  ...
  message: 'behaviour-builder can only write to creativeshire/components/experience/behaviour/. Check your contract.',
}
