#!/usr/bin/env npx tsx
/**
 * Chrome Builder Composite Validator
 *
 * Chains domain validators and/or enforces path rules for this agent.
 * Lives next to agent contract: ./chrome-builder.agent.md
 *
...
const AGENT_NAME = 'chrome-builder'
...
const domainValidators: string[] = [
  '../../creativeshire/components/content/chrome.validator.ts',
]
...
const pathRules: {
  ...
  message: 'chrome-builder can only write to creativeshire/components/content/chrome/. Check your contract.',
}
