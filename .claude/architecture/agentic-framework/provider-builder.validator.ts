#!/usr/bin/env npx tsx
/**
 * Provider Builder Composite Validator
 *
 * Chains domain validators and/or enforces path rules for this agent.
 * Lives next to agent contract: ./provider-builder.agent.md
 *
...
const AGENT_NAME = 'provider-builder'
...
const domainValidators: string[] = [
  '../../creativeshire/components/experience/provider.validator.ts',
]
...
const pathRules: {
  ...
  message: 'Provider builder can only write to creativeshire/components/experience/provider/. Check your contract.',
}
