#!/usr/bin/env npx tsx
/**
 * Widget Composite Builder Composite Validator
 *
 * Chains domain validators and/or enforces path rules for this agent.
 * Lives next to agent contract: ./widget-composite-builder.agent.md
 *
...
const AGENT_NAME = 'widget-composite-builder'
...
const domainValidators: string[] = [
  '../../creativeshire/components/content/widget-composite.validator.ts',
]
...
const pathRules: {
  ...
  message: 'Widget composite builder can only write to creativeshire/components/content/widgets/composites/. Check your contract.',
}
