#!/usr/bin/env npx tsx
/**
 * Inventory Agent Composite Validator
 *
 * Chains domain validators and/or enforces path rules for this agent.
 * Lives next to agent contract: ./inventory-agent.agent.md
 *
...
const domainValidators: string[] = [
  // Inventory agent is a coordinator - no domain validators needed
]
...
const pathRules: {
  ...
  message: 'inventory-agent can only write to .claude/tasks/ and .claude/development/. Check your contract.',
}
